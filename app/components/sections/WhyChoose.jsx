...
const features = [
  {
    ...
    icon: Clipboard,
    title: 'PMS',
    description: 'Manage reservations, housekeeping, and front desk operations seamlessly.',
    image: '/image copy 9.png',
    tag: 'Day-to-Day Essentials'
  },
  {
    id: 'ai-concierge',
    icon: Bot,
    title: 'AI Concierge',
    description: 'Provide 24/7 guest support with intelligent AI-powered assistance.',
...
const WhyChoose = () => {
  const [activeFeature, setActiveFeature] = useState('guest-app');
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-[#0a1628] mb-4">
              Daily Operations & Guest Experience Management
            </h2>
            
            <p className="text-gray-600 text-lg mb-8">
              Essential tools that streamline your day-to-day operations while delivering exceptional guest experiences.
            </p>
