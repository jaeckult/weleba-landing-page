      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div className="bg-[#0066FF] rounded-[3rem] p-12 lg:p-16 text-white relative overflow-hidden mb-8">
          ...
          <div className="absolute top-8 left-8 lg:top-12 lg:left-12">
            <div className="text-white font-bold text-2xl uppercase tracking-tighter">
            ...
            <div className="flex justify-center gap-2 mb-8">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-1 rounded-full transition-all ${index === currentSlide ? 'w-12 bg-white' : 'w-8 bg-white/40'
                    }`}
