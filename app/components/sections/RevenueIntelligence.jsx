                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
                    ...
                    <div className="bg-gradient-to-br from-gray-100 to-gray-200 p-8 lg:p-12 rounded-3xl shadow-lg hover:shadow-2xl transition-all group relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <div className="relative mt-8">
                                <img
                                    src="/revenue-intelligence-no-dollars.png"
                                    alt="Revenue Intelligence Dashboard"
                    ...
                    <div className="bg-gradient-to-br from-gray-100 to-gray-200 p-8 lg:p-12 rounded-3xl shadow-lg hover:shadow-2xl transition-all group relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-700 text-lg mb-8 max-w-md">
                                Building on our years of providing hospitality software, weleba understands your operational challenges because we've lived them.
                            </p>
                            ...
                            <div className="relative flex items-center justify-center mt-12">
                                ...
                                <div className="bg-white p-8 rounded-3xl shadow-2xl">
                                    ...
                                    <div className="text-center">
                                        <div className="text-5xl font-bold text-[#0a1628]">Many</div>
