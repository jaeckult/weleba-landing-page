...
export const rmWhyTrust = {
    ...
    features: [
        ...
        },
        {
            ...
            description: 'Continuously monitors competitor pricing across your market, automatically tracking rate changes to ensure you never miss an opportunity.',
            icon: 'BarChart3',
        },
        {
            title: 'Event Data Analysis',
            description: 'Automatically identify conferences, concerts, and festivals that impact your market, then adjust pricing to capitalize on high-demand periods.',
            icon: 'Calendar',
        },
    ],
};
...
export const rmBoundaries = {
    tag: 'Stay in Control',
    title: 'Set Boundaries, Stay in Control',
    features: [
        {
        ...
        },
        {
            ...
            description: 'Establish your own pricing rules and strategies, giving you the exact level of automation you desire.',
            icon: 'Sliders',
            className: 'bg-[#f4f1ea] col-span-1 md:col-span-6 lg:col-span-6 min-h-[350px]'
        }
    ],
    cta: {
        title: 'Ready to see how automated pricing can transform your bottom line?',
...
export const rmHowItWorks = {
    title: 'How It Works',
    subtitle: 'Collect + Analyze + Optimize',
    features: [
        {
            title: 'Collect',
        ...
        {
            title: 'Analyze',
            description: 'Advanced AI processes this information to identify pricing opportunities and demand patterns.',
            icon: 'PieChart',
        },
        {
            title: 'Optimize',
            description: 'Your rates are automatically adjusted according to your custom strategies, maximizing revenue.',
            icon: 'Zap',
        },
    ],
};
...
export const rmFaqs = [
    ...
    },
    {
        ...
        question: 'Does the revenue management system provide detailed forecasting?',
        answer: 'Yes, our system provides comprehensive demand forecasting using historical data, market trends, and local event analysis up to 365 days in advance.',
    },
];
