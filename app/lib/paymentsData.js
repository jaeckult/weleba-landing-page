...
export const paymentsAdvantages = {
    ...
    features: [
        ...
        },
        {
            ...
            description: 'Automated reconciliations and settlements save your staff 4-6 hours every week, eliminating manual entry errors.',
            icon: 'Zap',
        },
        {
            title: 'Built-In Protection',
            description: 'Minimize losses with built-in fraud screening and our specialized dispute resolution team handling chargebacks.',
            icon: 'ShieldCheck',
        },
    ],
};
...
export const paymentsPainless = {
    tag: 'Painless Payments',
    title: 'Features That Make Payments Painless',
    features: [
        {
...
export const paymentsReliability = {
    title: 'Reliability and Compliance You Can Trust',
    subtitle: 'PCI DSS & GDPR Compliance + 99.95% Uptime + Global Security Standards',
    features: [
        {
        ...
        {
            title: '24/7 Support',
            description: 'Our specialized payment support team is available 24/7 to help you resolve any transaction issues.',
            icon: 'Plus',
        },
    ],
};
...
export const paymentsFaqs = [
    ...
    {
        category: 'Support',
        question: 'What kind of support do we get after implementing weleba Payments?',
        answer: 'We provide 24/7 phone, email, and chat support. You\'ll have access to our knowledge base, regular webinars, and a dedicated account manager.',
    },
    {
        category: 'Strategy',
