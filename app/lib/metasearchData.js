...
export const msAdvantages = {
    ...
    features: [
        ...
        {
            title: 'Unified Metasearch Control',
            description: 'Automate budget allocation and optimization across all channels to maximize ROI and minimize effort.',
            icon: 'Sliders',
        },
        {
...
export const msPositioning = {
    ...
    cta: {
        title: 'Ready to amplify your visibility and win back your direct bookings?',
...
export const msFaqs = [
    ...
    {
        category: 'Platforms',
        question: 'What are the top hotel metasearch platforms?',
        answer: 'The leading platforms include Google Hotel Ads, Trivago, TripAdvisor, Kayak, and Skyscanner. weleba connects you to all of them.',
    },
];
