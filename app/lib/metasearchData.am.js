...
export const msAdvantages = {
    ...
    features: [
        ...
        {
            title: 'የተቀናጀ የሜታሰርች ቁጥጥር',
            description: 'በትንሹ ጥረት ከፍተኛ ውጤት ለማግኘት በሁሉም ቻናሎች ላይ ያለውን የገንዘብ ድልድል እና ማመቻቸት በራስ-ሰር ያከናውኑ።',
            icon: 'Sliders',
        },
        {
            title: 'ብልህ ማመቻቸት',
...
export const msPositioning = {
    ...
    cta: {
        title: 'ታይነትዎን ለመጨመር እና ቀጥተኛ ቦታ ማስያዝን ለማሳደግ ተዘጋጅተዋል?',
        buttonText: 'ማሳያ ያስይዙ',
        icon: 'Search',
...
export const msFaqs = [
    ...
    {
        category: 'መድረኮች',
        question: 'ዋና ዋና የሜታሰርች መድረኮች የትኞቹ ናቸው?',
        answer: 'Google Hotel Ads፣ Trivago፣ TripAdvisor፣ Kayak እና Skyscanner ዋና ዋናዎቹ ናቸው። weleba ከሁሉም ጋር ያገናኝዎታል።',
    },
];
