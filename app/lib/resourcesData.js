...
export const templatesList = [
    ...
    },
    {
        ...
        description: 'Improve communication between shifts with a standardized handover process that covers all critical details.',
        category: 'Operations',
    ...
    {
        title: 'Revenue Management Audit Checklist',
        description: 'A monthly checklist to ensure your pricing strategy is performing at its peak.',
        category: 'Revenue',
...
export const webinarsList = [
    {
        title: 'Maximizing Low Season Revenue',
...
export const calculatorsList = [
    {
        title: 'RevPAR & ADR Calculator',
        description: 'Quickly calculate your Revenue Per Available Room and Average Daily Rate to track financial health.',
        category: 'Finance',
        image: '/calculators/revpar.jpg',
        href: '/calculators/revpar'
    },
    {
        title: 'Commission Savings Estimator',
        description: 'See how much you could save annually by shifting just 10% of OTA bookings to direct.',
        category: 'Revenue',
    ...
    {
        title: 'Occupancy Forecasting Tool',
        description: 'A simple way to project future occupancy based on historical data and current pace.',
        category: 'Operations',
