...
export const gmAdvantages = {
    title: 'Unified Operations, Peace of Mind',
    subtitle: 'Fragmented Tech vs. Unified Dashboard',
    features: [
        {
            title: 'Unified Visibility',
            description: 'Real-time visibility into all operations through a single dashboard, eliminating operational blindspots.',
...
export const gmPlatform = {
    ...
    features: [
        ...
        },
        {
            ...
            description: 'AI-powered intelligence that automatically adjusts rates based on demand and market conditions.',
            icon: 'BarChart3',
            className: 'bg-[#dce6f2] col-span-1 md:col-span-4 lg:col-span-4 min-h-[350px]'
        },
        {
            title: 'Compliance & Security',
            description: 'PCI DSS compliant payment processing with fraud protection and automated reconciliation.',
            icon: 'ShieldCheck',
...
export const gmFaqs = [
    ...
    },
    {
        ...
        question: 'What data migration and integration services are included?',
        answer: 'Complete data transfer from existing systems plus seamless integration setup with your current technology stack.',
    },
    {
        category: 'Training',
        question: 'How does weleba support staff training and adoption?',
        answer: 'Role-specific training and an intuitive interface ensure successful team adoption and productivity speed.',
    },
    {
        category: 'Revenue',
