...
export const fdmAdvantages = {
    ...
    features: [
        {
            title: 'የ2 ሰዓት የቡድን ስልጠና',
            description: 'አዳዲስ ሰራተኞች ከሳምንታት ይልቅ በጥቂት ሰዓታት ውስጥ ስራ መጀመር ይችላሉ። በቀለም የተለዩ ምቹ ገጾች ሰራተኞችን ይመራሉ ስራቸውን ይመራሉ።',
            icon: 'Clock',
        },
        {
...
export const fdmFaqs = [
    ...
    {
        category: 'ስልጠና',
        question: 'ሰራተኞች welebaን በቀላሉ መለማመድ ይችላሉ?',
        answer: 'አዎ፣ አብዛኛዎቹ ሰራተኞች ከ2-3 ሰዓታት ባለው ጊዜ ውስጥ ስራውን መለማመድ ይችላሉ፤ በቀለሞች የተቀለለ ገጽ ስራውን ይመራቸዋል።',
    },
    {
        category: 'ትስስር',
        question: 'ካለን አሰራር ጋር መተሳሰር ይችላል?',
        answer: 'አዎ፣ ከ100 በላይ ከሚሆኑ ስርዓቶች ጋር ይገናኛል፤ ይህም በተለያዩ መተግበሪያዎች መካከል መቀያየርን ያስቀራል።',
    },
    {
        category: 'ቡድኖች',
