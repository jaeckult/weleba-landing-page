...
export const gmAdvantages = {
    title: 'የተቀናጀ አሠራር፣ ሙሉ እረፍት',
    subtitle: 'የተበታተኑ ቴክኖሎጂዎች ከተቀናጀ ዳሽቦርድ ጋር ሲነጻጸሩ',
    features: [
        {
            title: 'የተሟላ ታይነት',
            description: 'ሁሉንም ስራዎች በአንድ ዳሽቦርድ አማካኝነት በእውነተኛ ጊዜ ይቆጣጠሩ፤ ምንም አይነት የስራ ክፍተት አይኑር።',
...
export const gmPlatform = {
    ...
    features: [
        ...
        {
            title: 'የላቀ ገቢ',
            description: 'በፍላጎት እና በገበያ ሁኔታ ላይ በመመስረት ዋጋዎችን በራስ-ሰር የሚያስተካክል ብልህ ኤአይ (AI)።',
            icon: 'BarChart3',
            className: 'bg-[#dce6f2] col-span-1 md:col-span-4 lg:col-span-4 min-h-[350px]'
        },
        {
            title: 'ተገዢነት እና ደህንነት',
            description: 'ደህንነቱ የተጠበቀ የክፍያ ሂደት ከማጭበርበር ጥበቃ እና ከአውቶማቲክ ሒሳብ ማመሳሰል ጋር።',
            icon: 'ShieldCheck',
...
export const gmFaqs = [
    ...
    {
        category: 'ትግበራ',
        question: 'የመረጃ ሽግግር እና ትስስር አገልግሎቶች ተካተዋል?',
        answer: 'አዎ፣ ካለዎት ስርዓት ወደ weleba የተሟላ የመረጃ ሽግግር እና አሁን ከሚጠቀሙባቸው ቴክኖሎጂዎች ጋር የማስተሳሰር ስራ እንሰራለን።',
    },
    {
        category: 'ስልጠና',
        question: 'weleba ሰራተኞች እንዲለማመዱት እንዴት ይረዳል?',
        answer: 'እንደ ሰራተኛው የስራ ድርሻ የሚሰጥ ስልጠና እና ለመጠቀም ቀላል የሆነ ገጽ ሰራተኞች በፍጥነት እንዲለማመዱት ያደርጋል።',
    },
    {
        category: 'ገቢ',
