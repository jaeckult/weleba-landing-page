...
export const cmAdvantages = {
    ...
    features: [
        ...
        {
            title: 'Zero Added Commissions',
            description: 'Plan your distribution strategy without restrictions. Connect to the right channels with ZERO additional commissions or extra fees, maximizing your revenue.',
...
export const cmTakeControl = {
    tag: 'Distribution Control',
    ...
    cta: {
        title: 'Ready to expand your reach without increasing your overhead?',
...
export const cmReliability = {
    title: 'Reliability and Compliance You Can Trust',
    subtitle: 'GDPR Compliance + 99.95% Uptime + Access Anytime, Anywhere',
    features: [
        {
        ...
        {
            title: '99.95% Uptime',
            description: 'Industry-leading uptime guarantee minimizes disruptions to your operations.',
            icon: 'Zap',
        },
        {
